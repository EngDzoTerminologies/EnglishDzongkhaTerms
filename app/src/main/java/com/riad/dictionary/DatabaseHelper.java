...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    {
        Cursor c= myDataBase.rawQuery("SELECT en_definition,acronym,speech,dzo_definition,dzo_word,category,images FROM words WHERE en_word==('"+text+"') OR dzo_word=('"+text+"')",null);
        return c;
    }
